      ...
      <Container className="footer-wrapper">
            ...
            <div className="content">
              <ul>
                ...
                <li className="mb-3">
                  <a href="#">
                    ClearVoice
                    <p style={{ color: "#b5b6ba", fontSize: 14 }}>Content Marketing</p>
                  </a>
                </li>
                <li className="mb-3">
                  <a href="#">
                    Fiverr Workspace
                    <p style={{ color: "#b5b6ba", fontSize: 14 }}>Invoice Software</p>
                  </a>
                </li>
                <li className="mb-3">
                  <a href="#">
                    Learn
                    <p style={{ color: "#b5b6ba", fontSize: 14 }}>Online Courses</p>
                  </a>
                </li>
                <li className="mb-3">
        ...
        <div className="bottom d-flex">
          <div className="left">
            ...
            <p className="ml-4 copyright">@ Fiverr International Ltd. 2021</p>
          </div>
          <div className="right">
            <ul className="social d-flex flex-row mr-5 mb-0">
              <li>
                <span>
                  <svg fill="#7a7d85" width="20" height="17" viewBox="0 0 20 17" xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <span>
                  <svg fill="#7a7d85" width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <span>
                  <svg fill="#7a7d85" width="21" height="20" viewBox="0 0 21 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <section className="settings-button d-flex">
              ...
              <button className="btn-trigger">US$ USD</button>
